...
const hideDropdown = () => dropdownElem.classList.remove('input-wrapper__dropdown--show');
const showDropdown = () => dropdownElem.classList.add('input-wrapper__dropdown--show');
